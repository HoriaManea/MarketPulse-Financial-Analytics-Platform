...
export const DashboardCard = memo(({ stat, index }: DashboardCardProps) => {
  ...
  return (
    ...
    >
      <div className="border-[#243c5a]  border-border bg-[#12100F] bg-card/40 rounded-xl border p-6 transition-all duration-300 hover:shadow-lg">
        ...
        <div className="relative">
          <div className="mb-4 flex items-center justify-between">
            <div className={`rounded-lg p-1 ${stat.bgColor}`}>
